        ...
        <div class="card-body p-4">
            <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" class="form-control" id="phone" name="phone" value="{{ old('phone') ?? $user->phone }}" placeholder="Phone (820475845)" required>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <select class="select2 form-control" id="department" name="department">
                        @foreach($departments as $department)
                            <option value="{{ $department->code }}" @if($user->department_code==$department->code) selected @endif>{{ $department->code }} - {{ $department->name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="mb-4">
