...
class SpaceTasks extends Component
{
    public $space_id;
    public $space;
    public $tasks;
    ...
    public function mount($space_id)
    {
        ...
        $this->space = Space::where('id',$space_id)->first();
        $this->loadTasks();
    }
    ...
    public function loadTasks()
    {
        ...
        $this->tasks = Task::where([['space_id', '=', $this->space_id],['completed_at', '=', null]])
        ...
        $this->completedTasks = Task::where([['space_id', '=', $this->space_id],['completed_at', '!=', null]])->orderBy('completed_at', 'asc')->get();
    ...
    {
        return view('livewire.space-tasks');
    }
}
