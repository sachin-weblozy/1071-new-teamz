    ...
    <div class="datatables">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <select class="form-control" id="assignTo" name="assignTo" wire:model="assignTo">
                                ...
                                <span class="validation-text">
                                    @error('assignTo') <span>{{ $message }}</span> @enderror
                                </span>
                            </div>
                            <div class="form-group mt-3">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input class="form-control" id="deadline" name="deadline" type="datetime-local" id="example-datetime-local-input">
                            </div>
                            <div class="form-group mt-3">
      ...
      <script>
        ...
        $(document).on("click", ".updatetask", function () {
            ...
            if(taskType != 0){
                $('#insertcheckbox').append("<div class='form-group'><div class='login-one-inputs check'><input class='inp-cbx checktask' name='futurecheck' id='cbxedit' type='checkbox' style='display: none'/><label class='cbx' for='cbxedit'><span><svg width='12px' height='10px' viewbox='0 0 12 10'><polyline points='1.5 6 4.5 9 10.5 1'></polyline></svg></span> Update future recurring tasks?</label></div></div>");
            }
        });
      </script>
</div>